  ...
  try {
    ...
    for (const l of leads) {
      ...
      const anyCheckRan = l.email_valid != null || l.phone_valid != null || l.domain_valid != null
        || l.phone_confirmed != null || l.email_confirmed != null || l.area_code_valid != null;
      const [r] = await db.query(
        `INSERT INTO leads
          (company, ceo, email, phone, location, website, linkedin_url,
           ...
           phone_confirmed, email_confirmed, impressum_url, area_code_valid, verified_at,
